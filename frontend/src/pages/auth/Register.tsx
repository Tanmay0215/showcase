      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-purple-100">
            Create your account and start sharing your creative works
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${
                    errors.department
                      ? "border-red-300 focus:ring-red-500"
                      : "border-gray-300"
                  }`}
